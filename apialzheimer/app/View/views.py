...
class Clasificacion:
    ...
    def chatgpt(request):
        if request.method == 'POST':
            ...
            user_message = f'Quiero que me des una frase tipo reporte de los resultados que hay, tengo una imagen que es la radiografia del paciente, y una segunda imagen que es la explicacion de la prediccion hecha con mi modelo, entonces como tal tengo el gradiente integrado que muestra tejido vivo y muerto, los pixeles blancos vendrian a ser el tejido vivo del cerebro, y las zonas negras son el tejido muerto, entonces en base a eso quiero que me des un reporte de eso y que se clasifica como ${demencia} y con una probabilidad ${probabilidad} de certeza con la que se predijo. El reporte debe de ser de 150 palabras y no debe contar con titulos ni nada, solo un parrafo de 200 palabras.'
            print(user_message)
